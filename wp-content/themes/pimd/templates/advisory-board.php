<?php 
/**
* Template Name: PAGE::Advisory-board page
**/
get_header(); ?>
    <!--history banner-->
    <?php
...
if ($query->have_posts()) :
    ...
    <section class="executive-team-sec advisory-sec" data-aos="fade-up" data-aos-duration="1800">
        <div class="container">
           <div class="row">
              <div class="col-md-12">
                 <div class="executive-img">
                    <?php  $banner_image = get_field('banner_image');
                       if ($banner_image) {?>
                         <img src="<?php echo esc_url($banner_image['url']); ?>" alt="<?php echo esc_attr($banner_image['alt']);?>" srcset="" />
                    <?php }?>
                 </div>
              </div>
               <div class="col-md-12">
                  <div class="executive-content title-block">
                            <h2><?php the_title(); ?></h2>
